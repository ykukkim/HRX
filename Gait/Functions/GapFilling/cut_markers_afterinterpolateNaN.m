...
for j=1:length(cutVars) %only cut for the markers
    if isfield(interpolatedVD, (markerlist{j}))
        ...
        interpolatedfilledVD.(marker).Values.x_coord=interpolatedVD.(marker).Values.x_coord(startcut:finshcut);
        interpolatedfilledVD.(marker).Values.y_coord=interpolatedVD.(marker).Values.y_coord(startcut:finshcut);
        interpolatedfilledVD.(marker).Values.z_coord=interpolatedVD.(marker).Values.z_coord(startcut:finshcut);
